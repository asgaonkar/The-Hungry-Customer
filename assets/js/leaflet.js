...
(function(t, e, i) {
  ...
  typeof exports != i + ""
    ...
    (n.Class.extend = function(t) {
      ...
      t.statics && (n.extend(e, t.statics), delete t.statics),
        t.includes &&
          (n.Util.extend.apply(null, [o].concat(t.includes)),
          delete t.includes),
        t.options &&
          o.options &&
          (t.options = n.extend({}, o.options, t.options)),
        n.extend(o, t),
        (o._initHooks = []);
      var a = this;
      return (
        (o.callInitHooks = function() {
          if (!this._initHooksCalled) {
            ...
            for (var t = 0, e = o._initHooks.length; e > t; t++)
  ...
  (n.Mixin = {}),
    (n.Mixin.Events = {
      addEventListener: function(t, e, i) {
        ...
        for (t = n.Util.splitWords(t), a = 0, r = t.length; r > a; a++)
          (h[t[a]] = h[t[a]] || []),
            h[t[a]].push({ action: e, context: i || this });
        return this;
      },
      ...
      removeEventListener: function(t, e, i) {
        ...
        if ("object" == typeof t) {
          for (o in t)
            t.hasOwnProperty(o) && this.removeEventListener(o, t[o], e);
          return this;
        }
        for (t = n.Util.splitWords(t), a = 0, r = t.length; r > a; a++)
          if (this.hasEventListeners(t[a]))
            for (h = u[t[a]], l = h.length - 1; l >= 0; l--)
              (e && h[l].action !== e) ||
                (i && h[l].context !== i) ||
                h.splice(l, 1);
        return this;
      ...
      fireEvent: function(t, e) {
        ...
        for (
          var i = n.extend({ type: t, target: this }, e),
            o = this[s][t].slice(),
            a = 0,
            r = o.length;
          r > a;
          ...
          o[a].action.call(o[a].context || this, i);
        return this;
      }
    }),
    (n.Mixin.Events.on = n.Mixin.Events.addEventListener),
    (n.Mixin.Events.off = n.Mixin.Events.removeEventListener),
    (n.Mixin.Events.fire = n.Mixin.Events.fireEvent),
    (function() {
    ...
    (n.Bounds.prototype = {
      ...
      contains: function(t) {
        ...
        return (
          (t =
            "number" == typeof t[0] || t instanceof n.Point
              ? n.point(t)
              : n.bounds(t)),
          t instanceof n.Bounds ? ((e = t.min), (i = t.max)) : (e = i = t),
          e.x >= this.min.x &&
            i.x <= this.max.x &&
            e.y >= this.min.y &&
            i.y <= this.max.y
    ...
    (n.DomUtil = {
      ...
      getViewportOffset: function(t) {
        ...
        do {
          if (
            ((o += a.offsetTop || 0),
            (s += a.offsetLeft || 0),
            (o += parseInt(n.DomUtil.getStyle(a, "borderTopWidth"), 10) || 0),
            (s += parseInt(n.DomUtil.getStyle(a, "borderLeftWidth"), 10) || 0),
            (i = n.DomUtil.getStyle(a, "position")),
        ...
        do {
          ...
          (o -= a.scrollTop || 0),
            (s -= a.scrollLeft || 0),
            n.DomUtil.documentIsLtr() ||
              (!n.Browser.webkit && !h) ||
              ((s += a.scrollWidth - a.clientWidth),
              h &&
                "hidden" !== n.DomUtil.getStyle(a, "overflow-y") &&
                "hidden" !== n.DomUtil.getStyle(a, "overflow") &&
                (s += 17)),
            (a = a.parentNode);
        } while (a);
      ...
      documentIsLtr: function() {
        return (
          n.DomUtil._docIsLtrCached ||
            ((n.DomUtil._docIsLtrCached = !0),
            (n.DomUtil._docIsLtr =
              "ltr" === n.DomUtil.getStyle(e.body, "direction"))),
          n.DomUtil._docIsLtr
        );
      },
      ...
      disableTextSelection: function() {
        e.selection && e.selection.empty && e.selection.empty(),
          this._onselectstart ||
            ((this._onselectstart = e.onselectstart || null),
            (e.onselectstart = n.Util.falseFn));
      },
      enableTextSelection: function() {
        e.onselectstart === n.Util.falseFn &&
          ((e.onselectstart = this._onselectstart),
          (this._onselectstart = null));
      },
      hasClass: function(t, e) {
        return (
          t.className.length > 0 &&
          RegExp("(^|\\s)" + e + "(\\s|$)").test(t.className)
        );
      },
      addClass: function(t, e) {
        n.DomUtil.hasClass(t, e) ||
      ...
      setPosition: function(t, e, i) {
        (t._leaflet_pos = e),
          !i && n.Browser.any3d
            ? ((t.style[n.DomUtil.TRANSFORM] = n.DomUtil.getTranslateString(e)),
              n.Browser.mobileWebkit3d &&
    ...
    (n.DomUtil.TRANSITION = n.DomUtil.testProp([
      "webkitTransition",
      "transition",
      "OTransition",
      "MozTransition",
    ...
    (n.DomUtil.TRANSITION_END =
      "webkitTransition" === n.DomUtil.TRANSITION ||
      "OTransition" === n.DomUtil.TRANSITION
        ? n.DomUtil.TRANSITION + "End"
        : "transitionend"),
    ...
    (n.LatLngBounds.prototype = {
        ...
        return (
          ...
          t instanceof n.LatLng
            ? this._southWest || this._northEast
              ...
              : ((this._southWest = new n.LatLng(t.lat, t.lng)),
                (this._northEast = new n.LatLng(t.lat, t.lng)))
      ...
      pad: function(t) {
        ...
        return new n.LatLngBounds(
          new n.LatLng(e.lat - o, e.lng - s),
          new n.LatLng(i.lat + o, i.lng + s)
        );
      },
      getCenter: function() {
        return new n.LatLng(
      ...
      contains: function(t) {
        t =
          "number" == typeof t[0] || t instanceof n.LatLng
            ? n.latLng(t)
            : n.latLngBounds(t);
        var e,
          i,
        ...
        return (
          t instanceof n.LatLngBounds
            ...
            : (e = i = t),
          e.lat >= o.lat && i.lat <= s.lat && e.lng >= o.lng && i.lng <= s.lng
        );
      },
      intersects: function(t) {
        t = n.latLngBounds(t);
    ...
    (n.CRS.EPSG3857 = n.extend({}, n.CRS, {
      ...
      transformation: new n.Transformation(
        0.5 / Math.PI,
        0.5,
        -0.5 / Math.PI,
        0.5
    ...
    (n.CRS.EPSG900913 = n.extend({}, n.CRS.EPSG3857, { code: "EPSG:900913" })),
    (n.CRS.EPSG4326 = n.extend({}, n.CRS, {
      code: "EPSG:4326",
      projection: n.Projection.LonLat,
      transformation: new n.Transformation(1 / 360, 0.5, -1 / 360, 0.5)
    })),
    (n.Map = n.Class.extend({
      ...
      initialize: function(t, e) {
        (e = n.setOptions(this, e)),
          ...
          e.center &&
            e.zoom !== i &&
            this.setView(n.latLng(e.center), e.zoom, !0),
          this._initLayers(e.layers);
      },
      ...
      setMaxBounds: function(t) {
        if (((t = n.latLngBounds(t)), (this.options.maxBounds = t), !t))
          return (this._boundsMinZoom = null), this;
        var e = this.getBoundsZoom(t, !0);
        return (
          (this._boundsMinZoom = e),
          this._loaded &&
            (e > this._zoom
              ? this.setView(t.getCenter(), e)
              : this.panInsideBounds(t)),
          this
        );
      },
      ...
      addHandler: function(t, e) {
        return e
          ? ((this[t] = new e(this)), this.options[t] && this[t].enable(), this)
          : i;
      },
      getCenter: function() {
      ...
      getBoundsZoom: function(t, e) {
        ...
        do
          r++,
            (o = this.project(l, r)),
            (s = this.project(u, r)),
            (i = new n.Point(Math.abs(o.x - s.x), Math.abs(s.y - o.y))),
            (c = e ? i.x < a.x || i.y < a.y : i.x <= a.x && i.y <= a.y);
        while (c && h >= r);
      ...
      project: function(t, e) {
        return (
          (e = e === i ? this._zoom : e),
          this.options.crs.latLngToPoint(n.latLng(t), e)
        );
      },
      unproject: function(t, e) {
        return (
          (e = e === i ? this._zoom : e),
          this.options.crs.pointToLatLng(n.point(t), e)
        );
      },
      ...
      _initLayout: function() {
        ...
        n.DomUtil.addClass(t, "leaflet-container"),
          n.Browser.touch && n.DomUtil.addClass(t, "leaflet-touch"),
          this.options.fadeAnimation &&
            n.DomUtil.addClass(t, "leaflet-fade-anim");
      ...
      _initPanes: function() {
        ...
        this.options.markerZoomAnimation ||
          (n.DomUtil.addClass(t.markerPane, e),
          n.DomUtil.addClass(t.shadowPane, e),
          n.DomUtil.addClass(t.popupPane, e));
      },
      ...
      _resetView: function(t, e, i, o) {
        var s = this._zoom !== e;
        o || (this.fire("movestart"), s && this.fire("zoomstart")),
          (this._zoom = e),
        ...
        for (t in this._zoomBoundLayers)
          if (this._zoomBoundLayers.hasOwnProperty(t)) {
            ...
            isNaN(o.options.minZoom) || (e = Math.min(e, o.options.minZoom)),
              isNaN(o.options.maxZoom) || (n = Math.max(n, o.options.maxZoom));
          }
        t === i
      ...
      _initEvents: function() {
        if (n.DomEvent) {
          ...
          for (e = 0, i = o.length; i > e; e++)
            n.DomEvent.on(this._container, o[e], this._fireMouseEvent, this);
          this.options.trackResize &&
            n.DomEvent.on(t, "resize", this._onResize, this);
        }
      },
      _onResize: function() {
        n.Util.cancelAnimFrame(this._resizeRequest),
          (this._resizeRequest = n.Util.requestAnimFrame(
            this.invalidateSize,
            this,
            !1,
            this._container
      ...
      _onTileLayerLoad: function() {
        this._tileLayersToLoad--,
          this._tileLayersNum &&
            ...
            (this._clearTileBgTimer = setTimeout(
              n.bind(this._clearTileBg, this),
              500
            )));
      },
    ...
    (n.Projection.Mercator = {
      ...
      project: function(t) {
        ...
        var _ = Math.tan(0.5 * (0.5 * Math.PI - h)) / c;
        return (h = -a * Math.log(_)), new n.Point(r, h);
      },
      unproject: function(t) {
        for (
          var e,
            i = n.LatLng.RAD_TO_DEG,
            o = this.R_MAJOR,
            s = this.R_MINOR,
            a = (t.x * i) / o,
            r = s / o,
    ...
    (n.TileLayer = n.Class.extend({
      ...
      onAdd: function(t) {
        (this._map = t),
          ...
          t.on({ viewreset: this._resetCallback, moveend: this._update }, this),
          this.options.updateWhenIdle ||
            ((this._limitedUpdate = n.Util.limitExecByInterval(
              this._update,
              150,
              this
            )),
      ...
      onRemove: function(t) {
        this._container.parentNode.removeChild(this._container),
          t.off(
            { viewreset: this._resetCallback, moveend: this._update },
            this
          ),
          this.options.updateWhenIdle ||
      ...
      redraw: function() {
        return (
          this._map &&
            ((this._map._panes.tilePane.empty = !1),
            this._reset(!0),
            this._update()),
          this
        );
      ...
      _initContainer: function() {
        var t = this._map._panes.tilePane;
        (!this._container || t.empty) &&
          ((this._container = n.DomUtil.create("div", "leaflet-layer")),
          this._updateZIndex(),
      ...
      _reset: function(t) {
        var e = this._tiles;
        for (var i in e)
          e.hasOwnProperty(i) && this.fire("tileunload", { tile: e[i] });
        (this._tiles = {}),
          (this._tilesToLoad = 0),
          this.options.reuseTiles && (this._unusedTiles = []),
          t && this._container && (this._container.innerHTML = ""),
          this._initContainer();
      },
      _update: function() {
        if (this._map) {
          ...
          if (!(e > this.options.maxZoom || this.options.minZoom > e)) {
            var o = new n.Point(
                Math.floor(t.min.x / i),
                Math.floor(t.min.y / i)
              ),
      ...
      _addTilesFromCenterOut: function(t) {
        ...
        for (i = t.min.y; t.max.y >= i; i++)
          for (o = t.min.x; t.max.x >= o; o++)
            (s = new n.Point(o, i)), this._tileShouldBeLoaded(s) && a.push(s);
        var h = a.length;
        if (0 !== h) {
          a.sort(function(t, e) {
      ...
      _tileShouldBeLoaded: function(t) {
        ...
        if (!this.options.continuousWorld) {
          ...
          if (
            (this.options.noWrap && (0 > t.x || t.x >= e)) ||
            0 > t.y ||
            t.y >= e
          )
            return !1;
      ...
      _removeOtherTiles: function(t) {
        ...
        for (o in this._tiles)
          this._tiles.hasOwnProperty(o) &&
            ((e = o.split(":")),
            (i = parseInt(e[0], 10)),
            (n = parseInt(e[1], 10)),
            (t.min.x > i || i > t.max.x || t.min.y > n || n > t.max.y) &&
              this._removeTile(o));
      },
      _removeTile: function(t) {
        ...
        this.fire("tileunload", { tile: e, url: e.src }),
          this.options.reuseTiles
            ? (n.DomUtil.removeClass(e, "leaflet-tile-loaded"),
              this._unusedTiles.push(e))
            : e.parentNode === this._container &&
              this._container.removeChild(e),
          n.Browser.android || (e.src = n.Util.emptyImageUrl),
          delete this._tiles[t];
      },
      _addTile: function(t, e) {
        var i = this._getTilePos(t),
          o = this._getTile();
        n.DomUtil.setPosition(o, i, n.Browser.chrome || n.Browser.android23),
          (this._tiles[t.x + ":" + t.y] = o),
          this._loadTile(o, t),
          o.parentNode !== this._container && e.appendChild(o);
      },
      ...
      _tileOnLoad: function() {
        var t = this._layer;
        this.src !== n.Util.emptyImageUrl &&
          (n.DomUtil.addClass(this, "leaflet-tile-loaded"),
    ...
    (n.TileLayer.WMS = n.TileLayer.extend({
      ...
      initialize: function(t, e) {
        ...
        i.width = i.height =
          e.detectRetina && n.Browser.retina
            ? 2 * this.options.tileSize
      ...
      onAdd: function(t) {
        ...
        (this.wmsParams[e] = t.options.crs.code),
      ...
      getTileUrl: function(t, e) {
        ...
        var i = this._map,
          ...
          c = n.Util.template(this._url, { s: this._getSubdomain(t) });
    ...
    (n.TileLayer.Canvas = n.TileLayer.extend({
      ...
      _createTileProto: function() {
        var t = (this._canvasProto = n.DomUtil.create(
          "canvas",
          "leaflet-tile"
        ));
    ...
    (n.ImageOverlay = n.Class.extend({
      ...
      _initImage: function() {
        (this._image = n.DomUtil.create("img", "leaflet-image-layer")),
          this._map.options.zoomAnimation && n.Browser.any3d
            ? n.DomUtil.addClass(this._image, "leaflet-zoom-animated")
            : n.DomUtil.addClass(this._image, "leaflet-zoom-hide"),
          this._updateOpacity(),
          n.extend(this._image, {
            galleryimg: "no",
      ...
      _animateZoom: function(t) {
        var e = this._map,
          ...
          l = r._add(h._multiplyBy(0.5 * (1 - 1 / o)));
        i.style[n.DomUtil.TRANSFORM] =
          n.DomUtil.getTranslateString(l) + " scale(" + o + ") ";
      },
      _reset: function() {
        var t = this._image,
    ...
    (n.Icon = n.Class.extend({
      ...
      _setIconStyles: function(t, e) {
        ...
        (i =
          "shadow" === e
            ? n.point(o.shadowAnchor || o.iconAnchor)
            : n.point(o.iconAnchor)),
          ...
          n.Browser.ie6
            ? ((i = e.createElement("div")),
              (i.style.filter =
                ...
                t +
                '")'))
            : ((i = e.createElement("img")), (i.src = t)),
          i
        );
      },
      _getIconUrl: function(t) {
        return n.Browser.retina && this.options[t + "RetinaUrl"]
    ...
    (n.Icon.Default.imagePath = (function() {
      ...
      for (t = 0, i = s.length; i > t; t++)
        if (((n = s[t].src), (o = n.match(a))))
          return n.split(a)[0] + "/images";
    })()),
    (n.Marker = n.Class.extend({
      ...
      _initIcon: function() {
        var t = this.options,
          ...
          s = !1;
        this._icon ||
          ((this._icon = t.icon.createIcon()),
          t.title && (this._icon.title = t.title),
          this._initInteraction(),
          (s = 1 > this.options.opacity),
          n.DomUtil.addClass(this._icon, o),
          t.riseOnHover &&
            n.DomEvent.on(this._icon, "mouseover", this._bringToFront, this).on(
              this._icon,
              "mouseout",
              this._resetZIndex,
              this
          ...
          this._shadow ||
            ((this._shadow = t.icon.createShadow()),
            this._shadow &&
              (n.DomUtil.addClass(this._shadow, o),
              (s = 1 > this.options.opacity))),
          s && this._updateOpacity();
      ...
      _removeIcon: function() {
        ...
        this.options.riseOnHover &&
          n.DomEvent.off(this._icon, "mouseover", this._bringToFront).off(
            this._icon,
            "mouseout",
            this._resetZIndex
          ),
          t.markerPane.removeChild(this._icon),
          this._shadow && t.shadowPane.removeChild(this._shadow),
      ...
      _initInteraction: function() {
        if (this.options.clickable) {
          ...
          n.DomUtil.addClass(t, "leaflet-clickable"),
            n.DomEvent.on(t, "click", this._onMouseClick, this);
          for (var i = 0; e.length > i; i++)
            n.DomEvent.on(t, e[i], this._fireMouseEvent, this);
      ...
      _onMouseClick: function(t) {
        ...
        (this.hasEventListeners(t.type) || e) && n.DomEvent.stopPropagation(t),
          e ||
      ...
      _fireMouseEvent: function(t) {
        this.fire(t.type, { originalEvent: t }),
          ...
          "mousedown" !== t.type && n.DomEvent.stopPropagation(t);
      },
      setOpacity: function(t) {
        (this.options.opacity = t), this._map && this._updateOpacity();
      },
      _updateOpacity: function() {
        n.DomUtil.setOpacity(this._icon, this.options.opacity),
          this._shadow &&
            n.DomUtil.setOpacity(this._shadow, this.options.opacity);
      },
    ...
    (n.Popup = n.Class.extend({
      ...
      initialize: function(t, e) {
        n.setOptions(this, t),
          (this._source = e),
          (this._animated = n.Browser.any3d && this.options.zoomAnimation);
      },
      onAdd: function(t) {
        (this._map = t),
        ...
        e && n.DomUtil.setOpacity(this._container, 0),
          t._panes.popupPane.appendChild(this._container),
          t.on("viewreset", this._updatePosition, this),
          this._animated && t.on("zoomanim", this._zoomAnimation, this),
          t.options.closePopupOnClick && t.on("preclick", this._close, this),
          this._update(),
          e && n.DomUtil.setOpacity(this._container, 1);
      },
      addTo: function(t) {
        return t.addLayer(this), this;
      },
      ...
      onRemove: function(t) {
        t._panes.popupPane.removeChild(this._container),
          n.Util.falseFn(this._container.offsetWidth),
          t.off(
            {
          ...
          t.options.fadeAnimation && n.DomUtil.setOpacity(this._container, 0),
          (this._map = null);
      },
      setLatLng: function(t) {
      ...
      _close: function() {
        ...
        t &&
          ((t._popup = null),
          t.removeLayer(this).fire("popupclose", { popup: this }));
      },
      _initLayout: function() {
        var t,
          e = "leaflet-popup",
        ...
        this.options.closeButton &&
          ((t = this._closeButton = n.DomUtil.create(
            "a",
            e + "-close-button",
            o
          )),
          (t.href = "#close"),
          (t.innerHTML = "&#215;"),
          n.DomEvent.on(t, "click", this._onCloseButtonClick, this));
        var s = (this._wrapper = n.DomUtil.create(
          "div",
          e + "-content-wrapper",
          o
        ));
        n.DomEvent.disableClickPropagation(s),
          (this._contentNode = n.DomUtil.create("div", e + "-content", s)),
          n.DomEvent.on(
            this._contentNode,
            "mousewheel",
          ...
          (this._tip = n.DomUtil.create("div", e + "-tip", this._tipContainer));
      },
      _update: function() {
        this._map &&
      ...
      _updateLayout: function() {
        ...
        s && o > s
          ? ((e.height = s + "px"), n.DomUtil.addClass(t, a))
          : n.DomUtil.removeClass(t, a),
      ...
      _updatePosition: function() {
        if (this._map) {
          ...
          e && n.DomUtil.setPosition(this._container, t),
    ...
    n.Marker.include({
      ...
      bindPopup: function(t, e) {
        var i =
          n.point(this.options.icon.options.popupAnchor) || new n.Point(0, 0);
        return (
          (i = i.add(n.Popup.prototype.options.offset)),
          e && e.offset && (i = i.add(e.offset)),
          (e = n.extend({ offset: i }, e)),
          this._popup ||
            this.on("click", this.openPopup, this)
              .on("remove", this.closePopup, this)
              .on("move", this._movePopup, this),
          (this._popup = new n.Popup(e, this).setContent(t)),
          this
        );
      },
    ...
    n.Map.include({
      openPopup: function(t) {
        return (
          this.closePopup(),
          (this._popup = t),
          this.addLayer(t).fire("popupopen", { popup: this._popup })
        );
      },
      closePopup: function() {
        return this._popup && this._popup._close(), this;
    ...
    (n.LayerGroup = n.Class.extend({
      ...
      removeLayer: function(t) {
        var e = n.stamp(t);
        return (
          delete this._layers[e], this._map && this._map.removeLayer(t), this
        );
      },
      ...
      eachLayer: function(t, e) {
        for (var i in this._layers)
          this._layers.hasOwnProperty(i) && t.call(e, this._layers[i]);
      },
      setZIndex: function(t) {
    ...
    (n.FeatureGroup = n.LayerGroup.extend({
      ...
      addLayer: function(t) {
        return this._layers[n.stamp(t)]
          ? this
          : (t.on(n.FeatureGroup.EVENTS, this._propagateEvent, this),
      ...
      removeLayer: function(t) {
        return (
          t.off(n.FeatureGroup.EVENTS, this._propagateEvent, this),
    ...
    (n.Path = n.Class.extend({
      includes: [n.Mixin.Events],
      statics: {
        CLIP_PADDING: n.Browser.mobile
          ? Math.max(
              0,
              Math.min(
                0.5,
                (1280 / Math.max(t.innerWidth, t.innerHeight) - 1) / 2
              )
            )
          : 0.5
      },
      ...
      setStyle: function(t) {
        return (
          n.setOptions(this, t), this._container && this._updateStyle(), this
        );
      },
      redraw: function() {
    ...
    (n.Path.SVG_NS = "http://www.w3.org/2000/svg"),
    (n.Browser.svg = !(
      !e.createElementNS ||
      !e.createElementNS(n.Path.SVG_NS, "svg").createSVGRect
    )),
    (n.Path = n.Path.extend({
      ...
      _initEvents: function() {
        if (this.options.clickable) {
          ...
          for (
            ...
            n.DomEvent.on(this._container, t[e], this._fireMouseEvent, this);
        }
      },
      _onMouseClick: function(t) {
      ...
      _fireMouseEvent: function(t) {
        if (this.hasEventListeners(t.type)) {
          ...
          this.fire(t.type, {
            ...
            "contextmenu" === t.type && n.DomEvent.preventDefault(t),
            "mousemove" !== t.type && n.DomEvent.stopPropagation(t);
        }
      }
    })),
    n.Map.include({
      _initPathRoot: function() {
        this._pathRoot ||
          ((this._pathRoot = n.Path.prototype._createElement("svg")),
          this._panes.overlayPane.appendChild(this._pathRoot),
          this.options.zoomAnimation && n.Browser.any3d
      ...
      _animatePathZoom: function(t) {
        ...
        (this._pathRoot.style[n.DomUtil.TRANSFORM] =
          n.DomUtil.getTranslateString(i) + " scale(" + e + ") "),
          (this._pathZooming = !0);
      },
      ...
      _updateSvgViewport: function() {
        if (!this._pathZooming) {
          ...
          n.Browser.mobileWebkit && r.removeChild(a),
            n.DomUtil.setPosition(a, e),
            a.setAttribute("width", o),
            a.setAttribute("height", s),
            a.setAttribute("viewBox", [e.x, e.y, o, s].join(" ")),
            n.Browser.mobileWebkit && r.appendChild(a);
        }
      }
    }),
    n.Path.include({
      bindPopup: function(t, e) {
        return (
          (!this._popup || e) && (this._popup = new n.Popup(e, this)),
      ...
      n.Browser.svg || !n.Browser.vml
        ...
        : n.Path.extend({
            ...
            _initPath: function() {
              ...
              n.DomUtil.addClass(t, "leaflet-vml-shape"),
    ...
    (n.Path =
      (n.Path.SVG && !t.L_PREFER_CANVAS) || !n.Browser.canvas
        ? n.Path
        : n.Path.extend({
            ...
            _requestUpdate: function() {
              this._map &&
                !n.Path._updateRequest &&
                (n.Path._updateRequest = n.Util.requestAnimFrame(
            ...
            _drawPath: function() {
              ...
              for (
                ...
                for (e = 0, o = this._parts[t].length; o > e; e++)
                  (s = this._parts[t][e]),
                    (a = (0 === e ? "move" : "line") + "To"),
                    this._ctx[a](s.x, s.y);
    ...
    (n.LineUtil = {
      ...
      _getEdgeIntersection: function(t, e, o, s) {
        var a = e.x - t.x,
          ...
          l = s.max;
        return 8 & o
          ? new n.Point(t.x + (a * (l.y - t.y)) / r, l.y)
          : 4 & o
          ? new n.Point(t.x + (a * (h.y - t.y)) / r, h.y)
          : 2 & o
          ? new n.Point(l.x, t.y + (r * (l.x - t.x)) / a)
          : 1 & o
          ? new n.Point(h.x, t.y + (r * (h.x - t.x)) / a)
          : i;
      },
      ...
      _sqClosestPointOnSegment: function(t, e, i, o) {
        ...
        return (
          ...
          (h = t.x - a),
          (l = t.y - r),
          o ? h * h + l * l : new n.Point(a, r)
        );
      }
    }),
    (n.Polyline = n.Path.extend({
      initialize: function(t, e) {
        n.Path.prototype.initialize.call(this, e),
      ...
      closestLayerPoint: function(t) {
        for (
          var e, i, o = 1 / 0, s = this._parts, a = null, r = 0, h = s.length;
          h > r;
          r++
        )
          for (var l = s[r], u = 1, c = l.length; c > u; u++) {
            ...
            o > _ &&
              ((o = _), (a = n.LineUtil._sqClosestPointOnSegment(t, e, i)));
          }
      ...
      _getPathPartStr: function(t) {
        for (var e, i = n.Path.VML, o = 0, s = t.length, a = ""; s > o; o++)
          (e = t[o]), i && e._round(), (a += (o ? "L" : "M") + e.x + " " + e.y);
        return a;
      },
      _clipPoints: function() {
        ...
        var r = this._parts,
          ...
          l = n.LineUtil;
        for (t = 0, e = 0; a - 1 > t; t++)
          (o = l.clipSegment(s[t], s[t + 1], h, t)),
            o &&
              ((r[e] = r[e] || []),
              r[e].push(o[0]),
              (o[1] !== s[t + 1] || t === a - 2) && (r[e].push(o[1]), e++));
      },
      _simplifyPoints: function() {
        for (
          var t = this._parts, e = n.LineUtil, i = 0, o = t.length;
          o > i;
          i++
        )
      ...
      _updatePath: function() {
        this._map &&
          ...
          n.Path.prototype._updatePath.call(this));
      }
    })),
    ...
    (n.PolyUtil = {}),
    (n.PolyUtil.clipPolygon = function(t, e) {
      var i,
        o,
        s,
        a,
      ...
      for (a = 0; 4 > a; a++) {
        for (u = _[a], i = [], o = 0, l = t.length, s = l - 1; l > o; s = o++)
          (r = t[o]),
            (h = t[s]),
            r._code & u
              ? h._code & u ||
                ((c = d._getEdgeIntersection(h, r, u, e)),
    ...
    (n.Polygon = n.Polyline.extend({
      options: { fill: !0 },
      initialize: function(t, e) {
        n.Polyline.prototype.initialize.call(this, t, e),
          t &&
            n.Util.isArray(t[0]) &&
            "number" != typeof t[0][0] &&
      ...
      projectLatlngs: function() {
        if (
          (n.Polyline.prototype.projectLatlngs.call(this),
          (this._holePoints = []),
          this._holes)
        ) {
          var t, e, i, o;
          for (t = 0, i = this._holes.length; i > t; t++)
            for (
              this._holePoints[t] = [], e = 0, o = this._holes[t].length;
              o > e;
              e++
            )
    ...
    (function() {
      ...
      (n.MultiPolyline = t(n.Polyline)),
        (n.MultiPolygon = t(n.Polygon)),
        (n.multiPolyline = function(t, e) {
    ...
    (n.Circle = n.Path.extend({
      initialize: function(t, e, i) {
        n.Path.prototype.initialize.call(this, i),
          (this._latlng = n.latLng(t)),
          (this._mRadius = e);
      },
      options: { fill: !0 },
      ...
      projectLatlngs: function() {
        ...
        (this._point = this._map.latLngToLayerPoint(this._latlng)),
          (this._radius = Math.max(Math.round(this._point.x - i.x), 1));
      },
      getBounds: function() {
        var t = this._getLngRadius(),
      ...
      _getLngRadius: function() {
        return (
          this._getLatRadius() /
          Math.cos(n.LatLng.DEG_TO_RAD * this._latlng.lat)
        );
      },
      _checkIfEmpty: function() {
    ...
    (n.CircleMarker = n.Circle.extend({
      ...
      initialize: function(t, e) {
        n.Circle.prototype.initialize.call(this, t, null, e),
      ...
      _updateStyle: function() {
        n.Circle.prototype._updateStyle.call(this),
      ...
      n.Path.CANVAS
        ? {
            _containsPoint: function(t, e) {
              ...
              for (
                n.Browser.touch && (u += 10), i = 0, a = this._parts.length;
                a > i;
                i++
              )
                for (
                  l = this._parts[i], o = 0, r = l.length, s = r - 1;
                  r > o;
                  s = o++
                )
                  if (
                    (e || 0 !== o) &&
                    ((h = n.LineUtil.pointToSegmentDistance(t, l[s], l[o])),
                    u >= h)
                  )
                    return !0;
              return !1;
        ...
        ? {
            _containsPoint: function(t) {
              var e,
                ...
                l,
                u = !1;
              if (n.Polyline.prototype._containsPoint.call(this, t, !0))
                return !0;
    ...
    (n.GeoJSON = n.FeatureGroup.extend({
      ...
      addData: function(t) {
        var e,
          i,
          o = n.Util.isArray(t) ? t : t.features;
        if (o) {
          for (e = 0, i = o.length; i > e; e++)
            (o[e].geometries || o[e].geometry || o[e].features) &&
              this.addData(o[e]);
          return this;
        }
        var s = this.options;
      ...
      resetStyle: function(t) {
        ...
        e &&
          (n.Util.extend(t.options, t.defaultOptions),
        ...
        switch (h.type) {
          ...
          case "MultiPoint":
            for (s = 0, a = l.length; a > s; s++)
              (i = this.coordsToLatLng(l[s])),
                (r = e ? e(t, i) : new n.Marker(i)),
                u.push(r);
          ...
          case "GeometryCollection":
            for (s = 0, a = h.geometries.length; a > s; s++)
              (r = this.geometryToLayer(
                {
    ...
    (n.DomEvent = {
      addListener: function(t, e, o, s) {
        ...
        return t[u]
          ...
          : ((a = function(e) {
            ...
            n.Browser.msTouch && 0 === e.indexOf("touch")
              ? this.addMsTouchListener(t, e, a, l)
              : (n.Browser.touch &&
                  "dblclick" === e &&
                  this.addDoubleTapListener &&
                  this.addDoubleTapListener(t, a, l),
      ...
      removeListener: function(t, e, i) {
        ...
        if (a)
          return (
            n.Browser.msTouch && 0 === e.indexOf("touch")
              ? this.removeMsTouchListener(t, e, o)
              : n.Browser.touch &&
                "dblclick" === e &&
                this.removeDoubleTapListener
              ? this.removeDoubleTapListener(t, o)
      ...
      disableClickPropagation: function(t) {
        for (
          var e = n.DomEvent.stopPropagation, i = n.Draggable.START.length - 1;
          i >= 0;
          i--
        )
          n.DomEvent.addListener(t, n.Draggable.START[i], e);
        return n.DomEvent.addListener(t, "click", e).addListener(
          t,
          "dblclick",
          e
        );
    ...
    (n.DomEvent.off = n.DomEvent.removeListener),
    (n.Draggable = n.Class.extend({
      includes: n.Mixin.Events,
      statics: {
      ...
      initialize: function(t, e, i) {
        (this._element = t),
          ...
          (this._longPress = i && !n.Browser.msTouch);
      },
      enable: function() {
        if (!this._enabled) {
          for (var t = n.Draggable.START.length - 1; t >= 0; t--)
            n.DomEvent.on(
      ...
      _onDown: function(t) {
        if (
          !(
            (!n.Browser.touch && t.shiftKey) ||
            (1 !== t.which && 1 !== t.button && !t.touches) ||
            (n.DomEvent.preventDefault(t),
            n.DomEvent.stopPropagation(t),
            n.Draggable._disabled)
          )
        ) {
          ...
          n.Browser.touch &&
            ...
            n.DomUtil.addClass(s, "leaflet-active"),
            (this._moved = !1),
            this._moving ||
              ((this._startPoint = new n.Point(o.clientX, o.clientY)),
              (this._startPos = this._newPos = n.DomUtil.getPosition(
                this._element
              )),
              t.touches &&
                1 === t.touches.length &&
              ...
              n.DomEvent.on(e, n.Draggable.MOVE[t.type], this._onMove, this),
              n.DomEvent.on(e, n.Draggable.END[t.type], this._onUp, this));
        }
      },
      _onMove: function(t) {
        if (!(t.touches && t.touches.length > 1)) {
          ...
          (o.x || o.y) &&
            ...
            this._moved ||
              (this.fire("dragstart"),
              (this._moved = !0),
              (this._startPos = n.DomUtil.getPosition(this._element).subtract(
                o
              )),
              n.Browser.touch ||
                (n.DomUtil.disableTextSelection(), this._setMovingCursor())),
      ...
      _onUp: function(t) {
        ...
        if (
          ...
          "a" === s.tagName.toLowerCase() &&
            n.DomUtil.removeClass(s, "leaflet-active"),
            n.Draggable.TAP_TOLERANCE > a && (i = o);
        }
        n.Browser.touch ||
          (n.DomUtil.enableTextSelection(), this._restoreCursor());
        for (var r in n.Draggable.MOVE)
          n.Draggable.MOVE.hasOwnProperty(r) &&
            (n.DomEvent.off(e, n.Draggable.MOVE[r], this._onMove),
            n.DomEvent.off(e, n.Draggable.END[r], this._onUp));
        this._moved &&
          (n.Util.cancelAnimFrame(this._animRequest), this.fire("dragend")),
          (this._moving = !1),
          i && ((this._moved = !1), this._simulateEvent("click", i));
      },
    ...
    (n.Map.Drag = n.Handler.extend({
      ...
      _onViewReset: function() {
        ...
        (this._initialWorldOffset = e.subtract(t).x),
          (this._worldWidth = this._map.project(new n.LatLng(0, 180)).x);
      },
      _onPreDrag: function() {
    ...
    n.Map.addInitHook("addHandler", "doubleClickZoom", n.Map.DoubleClickZoom),
    n.Map.mergeOptions({ scrollWheelZoom: !0 }),
    (n.Map.ScrollWheelZoom = n.Handler.extend({
      ...
      _onWheelScroll: function(t) {
        ...
        clearTimeout(this._timer),
          (this._timer = setTimeout(n.bind(this._performZoom, this), i)),
          n.DomEvent.preventDefault(t),
          n.DomEvent.stopPropagation(t);
      },
      _performZoom: function() {
        var t = this._map,
          ...
          i = t.getZoom();
        if (
          ((e = e > 0 ? Math.ceil(e) : Math.round(e)),
    ...
    n.Map.addInitHook("addHandler", "scrollWheelZoom", n.Map.ScrollWheelZoom),
    n.extend(n.DomEvent, {
      ...
      addDoubleTapListener: function(t, i, o) {
          ...
          if (l) {
            if (n.Browser.msTouch) {
              var o,
                s = {};
              for (var a in h)
                (o = h[a]), (s[a] = "function" == typeof o ? o.bind(h) : o);
              h = s;
            }
        ...
        return (
          t.addEventListener(_, s, !1),
          m.addEventListener(d, a, !1),
          n.Browser.msTouch && m.addEventListener("MSPointerCancel", a, !1),
          this
        );
      },
      removeDoubleTapListener: function(t, i) {
        ...
        return (
          t.removeEventListener(
            this._touchstart,
            t[o + this._touchstart + i],
            !1
          ),
          (n.Browser.msTouch ? e.documentElement : t).removeEventListener(
            this._touchend,
            t[o + this._touchend + i],
            !1
          ),
          n.Browser.msTouch &&
    ...
    n.Map.mergeOptions({ touchZoom: n.Browser.touch && !n.Browser.android23 }),
    (n.Map.TouchZoom = n.Handler.extend({
      ...
      _onTouchStart: function(t) {
        ...
        if (
          ...
          (this._startCenter = o.add(s)._divideBy(2)),
            ...
            n.DomEvent.on(e, "touchmove", this._onTouchMove, this).on(
              e,
              "touchend",
              this._onTouchEnd,
              this
          ...
          (this._scale = i.distanceTo(o) / this._startDist),
            ...
            1 !== this._scale &&
              (this._moved ||
                (n.DomUtil.addClass(
                  e._mapPane,
                  "leaflet-zoom-anim leaflet-touching"
                ),
                e
                  .fire("movestart")
                  .fire("zoomstart")
      ...
      _updateOnMove: function() {
        ...
        t.fire("zoomanim", { center: i, zoom: t.getScaleZoom(this._scale) }),
          (t._tileBg.style[n.DomUtil.TRANSFORM] =
            n.DomUtil.getTranslateString(this._delta) +
            " " +
            n.DomUtil.getScaleString(this._scale, this._startCenter));
      },
      _onTouchEnd: function() {
        if (this._moved && this._zooming) {
          var t = this._map;
          (this._zooming = !1),
            n.DomUtil.removeClass(t._mapPane, "leaflet-touching"),
            n.DomEvent.off(e, "touchmove", this._onTouchMove).off(
              e,
              "touchend",
              this._onTouchEnd
            );
          var i = this._getScaleOrigin(),
            ...
            h = t._limitZoom(s + r);
          t.fire("zoomanim", { center: o, zoom: h }),
    ...
    (n.Map.BoxZoom = n.Handler.extend({
      ...
      _onMouseDown: function(t) {
        return !t.shiftKey || (1 !== t.which && 1 !== t.button)
          ...
          : (n.DomUtil.disableTextSelection(),
            ...
            n.DomUtil.setPosition(this._box, this._startLayerPoint),
            (this._container.style.cursor = "crosshair"),
            n.DomEvent.on(e, "mousemove", this._onMouseMove, this)
      ...
      _onMouseUp: function(t) {
        this._pane.removeChild(this._box),
          ...
          n.DomEvent.off(e, "mousemove", this._onMouseMove).off(
            e,
            "mouseup",
            this._onMouseUp
          );
        ...
        if (!this._startLayerPoint.equals(o)) {
          var s = new n.LatLngBounds(
            i.layerPointToLatLng(this._startLayerPoint),
            i.layerPointToLatLng(o)
          );
    ...
    (n.Map.Keyboard = n.Handler.extend({
      ...
      addHooks: function() {
        ...
        -1 === t.tabIndex && (t.tabIndex = "0"),
          n.DomEvent.on(t, "focus", this._onFocus, this)
      ...
      removeHooks: function() {
        this._removeHooks();
        var t = this._map._container;
        n.DomEvent.off(t, "focus", this._onFocus, this)
      ...
      _onKeyDown: function(t) {
        var e = t.keyCode,
          i = this._map;
        if (this._panKeys.hasOwnProperty(e))
    ...
    (n.Handler.MarkerDrag = n.Handler.extend({
      ...
      addHooks: function() {
        ...
        this._draggable ||
          (this._draggable = new n.Draggable(t, t)
      ...
      _onDrag: function() {
        ...
        e && n.DomUtil.setPosition(e, i),
          (t._latlng = o),
          t.fire("move", { latlng: o }).fire("drag");
      },
      _onDragEnd: function() {
    ...
    (n.Handler.PolyEdit = n.Handler.extend({
      ...
      _initMarkers: function() {
        this._markerGroup || (this._markerGroup = new n.LayerGroup()),
          (this._markers = []);
        var t,
          e,
          i,
          o,
          s = this._poly._latlngs;
        for (t = 0, i = s.length; i > t; t++)
          (o = this._createMarker(s[t], t)),
            o.on("click", this._onMarkerClick, this),
            this._markers.push(o);
        var a, r;
        for (t = 0, e = i - 1; i > t; e = t++)
          (0 !== t || (n.Polygon && this._poly instanceof n.Polygon)) &&
            ((a = this._markers[e]),
            (r = this._markers[t]),
            this._createMiddleMarker(a, r),
            this._updatePrevNext(a, r));
      },
      ...
      _onMarkerDrag: function(t) {
        var e = t.target;
        n.extend(e._origLatLng, e._latlng),
          e._middleLeft &&
      ...
      _onMarkerClick: function(t) {
        if (!(3 > this._poly._latlngs.length)) {
          ...
          this._markerGroup.removeLayer(e),
            ...
            e._prev && e._next
              ? this._createMiddleMarker(e._prev, e._next)
              : e._prev
              ? e._next || (e._prev._middleRight = null)
              : (e._next._middleLeft = null),
            this._poly.fire("edit");
        }
      },
      ...
      _createMiddleMarker: function(t, e) {
        ...
        a.setOpacity(0.6),
          ...
          (n = function() {
            var n = e._index;
            (a._index = n),
              a.off("click", i).on("click", this._onMarkerClick, this),
              (s.lat = a.getLatLng().lat),
              (s.lng = a.getLatLng().lng),
              this._poly.spliceLatLngs(n, 0, s),
          ...
          (o = function() {
            a.off("dragstart", n, this),
              a.off("dragend", o, this),
    ...
    n.Polyline.addInitHook(function() {
      n.Handler.PolyEdit &&
        ((this.editing = new n.Handler.PolyEdit(this)),
    ...
    (n.Control = n.Class.extend({
      ...
      addTo: function(t) {
        ...
        return (
          n.DomUtil.addClass(e, "leaflet-control"),
          -1 !== i.indexOf("bottom")
    ...
    n.Map.include({
      ...
      _initControlPos: function() {
        ...
        var e = (this._controlCorners = {}),
          i = "leaflet-",
          o = (this._controlContainer = n.DomUtil.create(
            "div",
            i + "control-container",
            this._container
          ));
    ...
    (n.Control.Zoom = n.Control.extend({
      ...
      _createButton: function(t, e, i, o, s, a) {
        ...
        return (
          n.DomEvent.on(r, "click", h)
            .on(r, "mousedown", h)
            .on(r, "dblclick", h)
            .on(r, "click", n.DomEvent.preventDefault)
            .on(r, "click", s, a),
          r
        );
      },
      _updateDisabled: function() {
        ...
        n.DomUtil.removeClass(this._zoomInButton, e),
          n.DomUtil.removeClass(this._zoomOutButton, e),
          t._zoom === t.getMinZoom() &&
            n.DomUtil.addClass(this._zoomOutButton, e),
          t._zoom === t.getMaxZoom() &&
            n.DomUtil.addClass(this._zoomInButton, e);
      }
    })),
      ...
      _update: function() {
        if (this._map) {
          ...
          for (var e in this._attributions)
            this._attributions.hasOwnProperty(e) &&
    ...
    n.Map.addInitHook(function() {
      this.options.attributionControl &&
        (this.attributionControl = new n.Control.Attribution().addTo(this));
    }),
    ...
    (n.Control.Scale = n.Control.extend({
      ...
      _addScales: function(t, e, i) {
        t.metric && (this._mScale = n.DomUtil.create("div", e + "-line", i)),
          t.imperial &&
            (this._iScale = n.DomUtil.create("div", e + "-line", i));
      },
      _update: function() {
    ...
    (n.Control.Layers = n.Control.extend({
      ...
      onRemove: function(t) {
        t.off("layeradd", this._onLayerChange).off(
          "layerremove",
          this._onLayerChange
        );
      },
      ...
      _initLayout: function() {
        ...
        n.Browser.touch
          ? n.DomEvent.on(e, "click", n.DomEvent.stopPropagation)
          : (n.DomEvent.disableClickPropagation(e),
            n.DomEvent.on(e, "mousewheel", n.DomEvent.stopPropagation));
        var i = (this._form = n.DomUtil.create("form", t + "-list"));
        if (this.options.collapsed) {
          n.DomEvent.on(e, "mouseover", this._expand, this).on(
            e,
            "mouseout",
            this._collapse,
            this
          ...
          (o.href = "#"),
            (o.title = "Layers"),
            n.Browser.touch
              ? n.DomEvent.on(o, "click", n.DomEvent.stopPropagation)
                  .on(o, "click", n.DomEvent.preventDefault)
                  .on(o, "click", this._expand, this)
              : n.DomEvent.on(o, "focus", this._expand, this),
            this._map.on("movestart", this._collapse, this);
        } else this._expand();
        (this._baseLayersList = n.DomUtil.create("div", t + "-base", i)),
          (this._separator = n.DomUtil.create("div", t + "-separator", i)),
          (this._overlaysList = n.DomUtil.create("div", t + "-overlays", i)),
          e.appendChild(i);
      },
      _addLayer: function(t, e, i) {
        var o = n.stamp(t);
        (this._layers[o] = { layer: t, name: e, overlay: i }),
      ...
      _addItem: function(t) {
        ...
        t.overlay
          ...
          (i.layerId = n.stamp(t.layer)),
          n.DomEvent.on(i, "click", this._onInputClick, this);
    ...
    (n.PosAnimation = n.Class.extend({
      ...
      run: function(t, e, i, o) {
        this.stop(),
          ...
          (this._inProgress = !0),
          this.fire("start"),
          (t.style[n.DomUtil.TRANSITION] =
            "all " + (i || 0.25) + "s cubic-bezier(0,0," + (o || 0.5) + ",1)"),
          n.DomEvent.on(
            t,
            n.DomUtil.TRANSITION_END,
          ...
          n.DomUtil.setPosition(t, e),
          n.Util.falseFn(t.offsetWidth),
          (this._stepTimer = setInterval(n.bind(this.fire, this, "step"), 50));
      },
      stop: function() {
        this._inProgress &&
          (n.DomUtil.setPosition(this._el, this._getPos()),
          this._onTransitionEnd(),
          n.Util.falseFn(this._el.offsetWidth));
      },
      _transformRe: /(-?[\d\.]+), (-?[\d\.]+)\)/,
      _getPos: function() {
        var e,
        ...
        return (
          n.Browser.any3d
            ? ((o = a[n.DomUtil.TRANSFORM].match(this._transformRe)),
              (e = parseFloat(o[1])),
              (i = parseFloat(o[2])))
      ...
      _onTransitionEnd: function() {
        n.DomEvent.off(
          ...
          this._inProgress &&
            ((this._inProgress = !1),
            (this._el.style[n.DomUtil.TRANSITION] = ""),
    ...
    n.Map.include({
      setView: function(t, e, i) {
        ...
        if (this._loaded && !i && this._layers) {
          ...
          var o = n
            ? this._zoomToIfClose && this._zoomToIfClose(t, e)
            : this._panByIfClose(t);
      ...
      panBy: function(t, e, i) {
        ...
        var o = n.DomUtil.getPosition(this._mapPane)
          .subtract(t)
          ._round();
        return this._panAnim.run(this._mapPane, o, e || 0.25, i), this;
      },
    ...
    (n.PosAnimation = n.DomUtil.TRANSITION
      ? n.PosAnimation
      : n.PosAnimation.extend({
          run: function(t, e, i, o) {
            this.stop(),
              (this._el = t),
              (this._inProgress = !0),
    ...
    n.Map.mergeOptions({
      zoomAnimation:
        n.DomUtil.TRANSITION && !n.Browser.android23 && !n.Browser.mobileOpera
    }),
    n.DomUtil.TRANSITION &&
      n.Map.addInitHook(function() {
        n.DomEvent.on(
          this._mapPane,
          n.DomUtil.TRANSITION_END,
      ...
      n.DomUtil.TRANSITION
        ? {
            _zoomToIfClose: function(t, e) {
              ...
              n.DomUtil.addClass(this._mapPane, "leaflet-zoom-anim"),
                this.fire("movestart").fire("zoomstart"),
                this.fire("zoomanim", { center: t, zoom: e });
            ...
            _runAnimation: function(t, e, i, o, s) {
              (this._animateToCenter = t),
                ...
                n.Draggable && (n.Draggable._disabled = !0);
              var a = n.DomUtil.TRANSFORM,
                r = this._tileBg;
              clearTimeout(this._clearTileBgTimer),
                n.Util.falseFn(r.offsetWidth);
            ...
            _prepareTileBg: function() {
              ...
              if (
                e &&
                this._getLoadedTilesPercentage(e) > 0.5 &&
                0.5 > this._getLoadedTilesPercentage(t)
              )
                return (
              ...
              e ||
                ((e = this._tileBg = this._createPane(
                  "leaflet-tile-pane",
                  this._mapPane
                )),
                (e.style.zIndex = 1)),
                (e.style[n.DomUtil.TRANSFORM] = ""),
                (e.style.visibility = "hidden"),
                (e.empty = !0),
                (t.empty = !1),
                (this._tilePane = this._panes.tilePane = e);
              var o = (this._tileBg = t);
              n.DomUtil.addClass(o, "leaflet-zoom-animated"),
                this._stopLoadingImages(o);
            },
            ...
            _stopLoadingImages: function(t) {
              ...
              for (e = 0, i = s.length; i > e; e++)
                (o = s[e]),
                  o.complete ||
                    ((o.onload = n.Util.falseFn),
                    (o.onerror = n.Util.falseFn),
                    (o.src = n.Util.emptyImageUrl),
                    o.parentNode.removeChild(o));
            },
            _onZoomTransitionEnd: function() {
              this._restoreTileFront(),
                n.DomUtil.removeClass(this._mapPane, "leaflet-zoom-anim"),
                n.Util.falseFn(this._tileBg.offsetWidth),
                ...
                n.Draggable && (n.Draggable._disabled = !1);
            },
    ...
    n.Map.include({
      ...
      locate: function(t) {
        if (
          ((t = this._locationOptions = n.extend(
